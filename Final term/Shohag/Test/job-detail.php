...
$has_applied = $database->hasApplied($connection, $_SESSION['user_id'], $job_id);

// Check if saved
$is_saved = $database->isSavedJob($connection, $_SESSION['user_id'], $job_id);
...
<body>
    <div class="job-detail-container">
        ...
        <div class="apply-section" id="apply-section">
            <?php if ($has_applied): ?>
                ...
                <p><a href="my-applications.php">View My Applications</a></p>
            <?php else: ?>
                ...
                if ($days_left < 7): ?>
                    <p class="deadline-warning">⚠ Only <?php echo ceil($days_left); ?> days left to apply!</p>
                <?php endif; ?>
            <?php endif; ?>
        </div>
        ...
        <div class="application-form" id="application-form" style="display: none;">
            ...
            <form action="apply-job.php" method="POST" enctype="multipart/form-data" id="apply-form">
    ...
    <script>
        ...
        bookmarkBtn.addEventListener('click', function() {
            ...
            fetch('../api/toggle-saved-job.php', {
                method: 'POST',
                headers: {
