...
<head>
    ...
    <style>
        ...
        .count-badge { background: #eee; padding: 3px 8px; border-radius: 20px; font-weight: bold; }

        .btn-action { color: white; padding: 5px 10px; text-decoration: none; border-radius: 4px; font-size: 13px; }

        .btn-edit { background: #f39c12; }
        .btn-delete { background: red; }

        .btn-toggle { border: none; padding: 6px 12px; border-radius: 20px; font-weight: bold; cursor: pointer; }
...
<div class="container">
    ...
    <div class="header-section">
        ...
        <div class="top-actions">
            ...
            <a href="../View/EditProfileEmployee.php" class="btn-profile">
                Edit Profile
            </a>
    ...
    <div class="stats-container">
        <div class="stat-box"><h4>Total Jobs</h4><p><?php echo $total_jobs; ?></p></div>
        <div class="stat-box"><h4>Active Jobs</h4><p><?php echo $active_jobs; ?></p></div>
        <div class="stat-box"><h4>Total Applications</h4><p><?php echo $total_applications; ?></p></div>
    </div>
        ...
        <?php if ($my_jobs && $my_jobs->num_rows > 0): ?>
            <?php while ($row = $my_jobs->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><span class="count-badge"><?php echo $row['application_count']; ?></span></td>
                    ...
                    <td>
                    <a href="./EditJob.php?id=<?php echo $row['id']; ?>" class="btn-action btn-edit">Edit</a>
                        <a href="../Controller/JobController.php?delete_job_id=<?php echo $row['id']; ?>" class="btn-action btn-delete">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        <?php endif; ?>
